...
from keras.layers import Dense, CuDNNGRU, LSTM
from keras.optimizers import adam
from keras.callbacks import ModelCheckpoint

cb = [ModelCheckpoint("model12.hdf5", save_best_only=True)]

model = Sequential()
model.add(CuDNNLSTM(50, input_shape=(None, n_features), return_sequences=True))
model.add(Dropout(0.3))
model.add(CuDNNLSTM(35, input_shape=(None, n_features)))
model.add(Dropout(0.3))
